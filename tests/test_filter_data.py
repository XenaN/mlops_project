...
def test_cli_command():
    result = runner.invoke(filter_data,
...
def test_output():
    ...
    expected_columns = ["Countrycode", "Namespace", "AirQualityNetwork",
                        "AirQualityStation", "AirQualityStationEoICode",
                        "SamplingPoint", "SamplingProcess", "Sample",
                        "AirPollutant", "AirPollutantCode", "AveragingTime",
    ...
    assert df_ge.expect_column_values_to_be_unique(
